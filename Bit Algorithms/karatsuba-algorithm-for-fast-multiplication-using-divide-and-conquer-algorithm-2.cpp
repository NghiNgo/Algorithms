...
int main(int argc, const char *argv[])
{
    ...
    cin >> firstNumber;
    cout << endl
        << "Please give the Second Binary number : ";
    cin >> secondNumber;
    cout << endl;
    ...
    cout << float(clock() - classical_time) / CLOCKS_PER_SEC << endl
        << endl;
