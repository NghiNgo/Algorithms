...
{
	// If total marks are not same then returns true for higher total
	if (a.total != b.total)
		return a.total > b.total;

	// If marks in Maths are same then returns true for higher marks
	if (a.math != b.math)
...
void computeRanks(Student a[], int n)
{
	...
	// Sort structure array using user defined function compareTwoStudents()
